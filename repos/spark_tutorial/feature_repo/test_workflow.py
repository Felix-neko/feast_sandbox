...
def run_demo():
    ...
    repo_config = load_repo_config(store.repo_path, store.repo_path / "feature_store.yaml")
    apply_total(repo_config, store.repo_path, skip_source_validation=True)
