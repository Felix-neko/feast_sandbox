...
if __name__ == "__main__":
    ...
    download_data("feast-oss.fraud_tutorial.transactions",
                  str(fraud_parquet_repo_path / "transactions.parquet"),
                  field_name_map={"timestamp": "feature_timestamp"})
    download_data("feast-oss.fraud_tutorial.user_has_fraudulent_transactions",
                  str(fraud_parquet_repo_path / "user_has_fraudulent_transactions.parquet"))
    download_data("feast-oss.fraud_tutorial.user_account_features",
                  str(fraud_parquet_repo_path / "user_account_features.parquet"))

    download_data("integral-server-329913.feast_fraud_ds.user_count_transactions_7d",
